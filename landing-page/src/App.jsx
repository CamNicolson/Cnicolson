...
const THEME_PRESETS = [
  ...
  },
  {
    label: 'Cloud',
    fog: {
      highlightColor: 0xd8e8f5,
      midtoneColor: 0xbccfe4,
      lowlightColor: 0x95b5cf,
      baseColor: 0xf4f8fb,
    },
    variables: {
      '--page-bg': '#f4f8fb',
      '--page-text': '#18222d',
      '--shell-radial-one': 'rgba(163, 196, 228, 0.46)',
      '--shell-radial-two': 'rgba(209, 223, 239, 0.72)',
      '--shell-base-start': '#fbfdff',
      '--shell-base-mid': '#edf4fa',
      '--shell-base-end': '#dee9f3',
      '--orb-one': 'rgba(132, 177, 222, 0.34)',
      '--orb-two': 'rgba(167, 188, 226, 0.28)',
      '--orb-three': 'rgba(187, 213, 236, 0.3)',
      '--orb-four': 'rgba(136, 202, 221, 0.24)',
      '--surface-border': 'rgba(120, 149, 178, 0.18)',
      '--surface-fill-top': 'rgba(255, 255, 255, 0.84)',
      '--surface-fill-bottom': 'rgba(238, 245, 250, 0.68)',
      '--surface-shadow': 'rgba(148, 171, 194, 0.22)',
      '--weather-glow': 'rgba(139, 186, 231, 0.28)',
      '--snake-glow': 'rgba(145, 222, 214, 0.2)',
      '--hero-panel-glow': 'rgba(152, 184, 229, 0.22)',
      '--text-strong': '#17222d',
      '--text-muted': 'rgba(23, 34, 45, 0.78)',
      '--text-soft': 'rgba(23, 34, 45, 0.62)',
      '--chip-bg': 'rgba(91, 154, 222, 0.14)',
      '--chip-border': 'rgba(91, 154, 222, 0.24)',
      '--chip-text': '#3179b8',
      '--primary-bg': '#1e2b38',
      '--primary-text': '#f7fbff',
      '--secondary-bg': 'rgba(255, 255, 255, 0.58)',
      '--secondary-border': 'rgba(120, 149, 178, 0.2)',
      '--secondary-text': '#213242',
      '--surface-inset': 'rgba(255, 255, 255, 0.62)',
      '--surface-inset-strong': 'rgba(255, 255, 255, 0.72)',
      '--line-soft': 'rgba(120, 149, 178, 0.16)',
      '--line-strong': 'rgba(120, 149, 178, 0.24)',
      '--slider-track': 'rgba(91, 154, 222, 0.16)',
      '--snake-button-bg': 'rgba(255, 255, 255, 0.64)',
      '--snake-button-border': 'rgba(120, 149, 178, 0.2)',
      '--snake-button-text': '#213242',
      '--snake-button-hover-border': 'rgba(49, 121, 184, 0.28)',
      '--snake-button-hover-bg': 'rgba(49, 121, 184, 0.1)',
      '--snake-board-border': 'rgba(120, 149, 178, 0.18)',
      '--snake-board-top': 'rgba(219, 232, 243, 0.98)',
      '--snake-board-bottom': 'rgba(194, 213, 229, 0.94)',
      '--snake-focus-ring': 'rgba(49, 121, 184, 0.38)',
      '--snake-focus_glow': 'rgba(49, 121, 184, 0.12)',
      '--snake-cell-bg': 'rgba(95, 129, 161, 0.22)',
      '--snake-head-shadow': 'rgba(43, 157, 120, 0.3)',
      '--snake-food-shadow': 'rgba(194, 133, 22, 0.28)',
      '--footer-text': 'rgba(23, 34, 45, 0.52)',
      '--project-button-bg-top': '#243445',
      '--project-button-bg-bottom': '#182430',
      '--project-button-border': 'rgba(24, 36, 48, 0.18)',
      '--project-button-text': '#f7fbff',
      '--project-button-shadow': 'rgba(36, 52, 69, 0.16)',
      '--project-button-shadow-hover': 'rgba(36, 52, 69, 0.22)',
      '--eyebrow-bg': 'rgba(255, 255, 255, 0.62)',
      '--eyebrow-border': 'rgba(120, 149, 178, 0.2)',
      '--eyebrow-text': '#274055',
    },
  },
  {
    label: 'Rose',
    fog: {
      highlightColor: 0xf7ddd9,
      midtoneColor: 0xf3b9c1,
      lowlightColor: 0xe695a7,
      baseColor: 0xfff6f5,
    },
    variables: {
      '--page-bg': '#fff6f5',
      '--page-text': '#2f1d20',
      '--shell-radial-one': 'rgba(244, 196, 204, 0.48)',
      '--shell-radial-two': 'rgba(255, 221, 211, 0.76)',
      '--shell-base-start': '#fffdfd',
      '--shell-base-mid': '#fff0ef',
      '--shell-base-end': '#f7dfe4',
      '--orb-one': 'rgba(236, 163, 184, 0.34)',
      '--orb-two': 'rgba(255, 174, 146, 0.28)',
      '--orb-three': 'rgba(244, 204, 182, 0.28)',
      '--orb-four': 'rgba(226, 154, 176, 0.24)',
      '--surface-border': 'rgba(188, 137, 149, 0.18)',
      '--surface-fill-top': 'rgba(255, 255, 255, 0.84)',
      '--surface-fill-bottom': 'rgba(255, 238, 241, 0.7)',
      '--surface-shadow': 'rgba(207, 164, 174, 0.22)',
      '--weather-glow': 'rgba(255, 181, 156, 0.24)',
      '--snake-glow': 'rgba(243, 181, 195, 0.2)',
      '--hero-panel-glow': 'rgba(235, 165, 186, 0.22)',
      '--text-strong': '#311f22',
      '--text-muted': 'rgba(49, 31, 34, 0.78)',
      '--text-soft': 'rgba(49, 31, 34, 0.62)',
      '--chip-bg': 'rgba(219, 104, 139, 0.14)',
      '--chip-border': 'rgba(219, 104, 139, 0.24)',
      '--chip-text': '#b94470',
      '--primary-bg': '#362125',
      '--primary-text': '#fff7f7',
      '--secondary-bg': 'rgba(255, 255, 255, 0.6)',
      '--secondary-border': 'rgba(188, 137, 149, 0.2)',
      '--secondary-text': '#4a2c31',
      '--surface-inset': 'rgba(255, 255, 255, 0.62)',
      '--surface-inset-strong': 'rgba(255, 255, 255, 0.72)',
      '--line-soft': 'rgba(188, 137, 149, 0.16)',
      '--line-strong': 'rgba(188, 137, 149, 0.24)',
      '--slider-track': 'rgba(219, 104, 139, 0.16)',
      '--snake-button-bg': 'rgba(255, 255, 255, 0.66)',
      '--snake-button-border': 'rgba(188, 137, 149, 0.2)',
      '--snake-button-text': '#4a2c31',
      '--snake-button-hover-border': 'rgba(185, 68, 112, 0.28)',
      '--snake-button-hover-bg': 'rgba(185, 68, 112, 0.1)',
      '--snake-board-border': 'rgba(188, 137, 149, 0.18)',
      '--snake-board-top': 'rgba(252, 236, 240, 0.98)',
      '--snake-board-bottom': 'rgba(242, 214, 222, 0.94)',
      '--snake-focus-ring': 'rgba(185, 68, 112, 0.36)',
      '--snake-focus_glow': 'rgba(185, 68, 112, 0.12)',
      '--snake-cell-bg': 'rgba(173, 104, 123, 0.18)',
      '--snake-head-shadow': 'rgba(43, 157, 120, 0.28)',
      '--snake-food-shadow': 'rgba(194, 133, 22, 0.28)',
      '--footer-text': 'rgba(49, 31, 34, 0.52)',
      '--project-button-bg-top': '#4a2c31',
      '--project-button-bg-bottom': '#311c20',
      '--project-button-border': 'rgba(49, 28, 32, 0.16)',
      '--project-button-text': '#fff7f7',
      '--project-button-shadow': 'rgba(74, 44, 49, 0.14)',
      '--project-button-shadow-hover': 'rgba(74, 44, 49, 0.2)',
      '--eyebrow-bg': 'rgba(255, 255, 255, 0.64)',
      '--eyebrow-border': 'rgba(188, 137, 149, 0.2)',
      '--eyebrow-text': '#5b3440',
    },
  },
  {
    label: 'Mint',
    fog: {
      highlightColor: 0xddf3eb,
      midtoneColor: 0xb8ead8,
      lowlightColor: 0x7fd4b7,
      baseColor: 0xf5fffb,
    },
    variables: {
      '--page-bg': '#f5fffb',
      '--page-text': '#173028',
      '--shell-radial-one': 'rgba(176, 238, 214, 0.46)',
      '--shell-radial-two': 'rgba(213, 247, 234, 0.78)',
      '--shell-base-start': '#fdfffe',
      '--shell-base-mid': '#effbf6',
      '--shell-base-end': '#ddf5ec',
      '--orb-one': 'rgba(110, 222, 182, 0.3)',
      '--orb-two': 'rgba(127, 214, 183, 0.26)',
      '--orb-three': 'rgba(142, 242, 214, 0.24)',
      '--orb-four': 'rgba(104, 188, 203, 0.2)',
      '--surface-border': 'rgba(111, 172, 149, 0.18)',
      '--surface-fill-top': 'rgba(255, 255, 255, 0.84)',
      '--surface-fill-bottom': 'rgba(234, 250, 243, 0.7)',
      '--surface-shadow': 'rgba(162, 204, 188, 0.22)',
      '--weather-glow': 'rgba(119, 221, 195, 0.24)',
      '--snake-glow': 'rgba(114, 236, 189, 0.24)',
      '--hero-panel-glow': 'rgba(126, 214, 187, 0.2)',
      '--text-strong': '#173028',
      '--text-muted': 'rgba(23, 48, 40, 0.78)',
      '--text-soft': 'rgba(23, 48, 40, 0.62)',
      '--chip-bg': 'rgba(60, 172, 129, 0.14)',
      '--chip-border': 'rgba(60, 172, 129, 0.22)',
      '--chip-text': '#278e68',
      '--primary-bg': '#18352d',
      '--primary-text': '#f6fffb',
      '--secondary-bg': 'rgba(255, 255, 255, 0.6)',
      '--secondary-border': 'rgba(111, 172, 149, 0.2)',
      '--secondary-text': '#22453b',
      '--surface-inset': 'rgba(255, 255, 255, 0.62)',
      '--surface-inset-strong': 'rgba(255, 255, 255, 0.72)',
      '--line-soft': 'rgba(111, 172, 149, 0.16)',
      '--line-strong': 'rgba(111, 172, 149, 0.24)',
      '--slider-track': 'rgba(60, 172, 129, 0.16)',
      '--snake-button-bg': 'rgba(255, 255, 255, 0.66)',
      '--snake-button-border': 'rgba(111, 172, 149, 0.2)',
      '--snake-button-text': '#22453b',
      '--snake-button-hover-border': 'rgba(39, 142, 104, 0.28)',
      '--snake-button-hover-bg': 'rgba(39, 142, 104, 0.1)',
      '--snake-board-border': 'rgba(111, 172, 149, 0.18)',
      '--snake-board-top': 'rgba(233, 247, 240, 0.98)',
      '--snake-board-bottom': 'rgba(209, 232, 220, 0.94)',
      '--snake-focus-ring': 'rgba(39, 142, 104, 0.36)',
      '--snake-focus_glow': 'rgba(39, 142, 104, 0.12)',
      '--snake-cell-bg': 'rgba(80, 143, 118, 0.18)',
      '--snake-head-shadow': 'rgba(39, 142, 104, 0.28)',
      '--snake-food-shadow': 'rgba(194, 133, 22, 0.28)',
      '--footer-text': 'rgba(23, 48, 40, 0.52)',
      '--project-button-bg-top': '#21453a',
      '--project-button-bg-bottom': '#173128',
      '--project-button-border': 'rgba(23, 49, 40, 0.16)',
      '--project-button-text': '#f6fffb',
      '--project-button-shadow': 'rgba(33, 69, 58, 0.14)',
      '--project-button-shadow-hover': 'rgba(33, 69, 58, 0.2)',
      '--eyebrow-bg': 'rgba(255, 255, 255, 0.64)',
      '--eyebrow-border': 'rgba(111, 172, 149, 0.2)',
      '--eyebrow-text': '#245545',
    },
  },
  {
    label: 'Lilac',
    fog: {
      highlightColor: 0xebe4fa,
      midtoneColor: 0xd3c3f6,
      lowlightColor: 0xb39ce8,
      baseColor: 0xfaf8ff,
    },
    variables: {
      '--page-bg': '#faf8ff',
      '--page-text': '#241d37',
      '--shell-radial-one': 'rgba(205, 192, 247, 0.46)',
      '--shell-radial-two': 'rgba(235, 228, 255, 0.78)',
      '--shell-base-start': '#fffefe',
      '--shell-base-mid': '#f4f0ff',
      '--shell-base-end': '#e6dcff',
      '--orb-one': 'rgba(174, 155, 241, 0.32)',
      '--orb-two': 'rgba(210, 183, 255, 0.28)',
      '--orb-three': 'rgba(188, 222, 255, 0.22)',
      '--orb-four': 'rgba(227, 186, 255, 0.2)',
      '--surface-border': 'rgba(138, 126, 191, 0.18)',
      '--surface-fill-top': 'rgba(255, 255, 255, 0.86)',
      '--surface-fill-bottom': 'rgba(242, 237, 255, 0.72)',
      '--surface-shadow': 'rgba(184, 174, 224, 0.24)',
      '--weather-glow': 'rgba(168, 148, 244, 0.22)',
      '--snake-glow': 'rgba(137, 197, 255, 0.18)',
      '--hero-panel-glow': 'rgba(197, 170, 255, 0.22)',
      '--text-strong': '#241d37',
      '--text-muted': 'rgba(36, 29, 55, 0.78)',
      '--text-soft': 'rgba(36, 29, 55, 0.62)',
      '--chip-bg': 'rgba(146, 118, 229, 0.14)',
      '--chip-border': 'rgba(146, 118, 229, 0.24)',
      '--chip-text': '#7558c8',
      '--primary-bg': '#292040',
      '--primary-text': '#faf7ff',
      '--secondary-bg': 'rgba(255, 255, 255, 0.62)',
      '--secondary-border': 'rgba(138, 126, 191, 0.2)',
      '--secondary-text': '#352b50',
      '--surface-inset': 'rgba(255, 255, 255, 0.64)',
      '--surface-inset-strong': 'rgba(255, 255, 255, 0.74)',
      '--line-soft': 'rgba(138, 126, 191, 0.16)',
      '--line-strong': 'rgba(138, 126, 191, 0.24)',
      '--slider-track': 'rgba(146, 118, 229, 0.16)',
      '--snake-button-bg': 'rgba(255, 255, 255, 0.68)',
      '--snake-button-border': 'rgba(138, 126, 191, 0.2)',
      '--snake-button-text': '#352b50',
      '--snake-button-hover-border': 'rgba(117, 88, 200, 0.28)',
      '--snake-button-hover-bg': 'rgba(117, 88, 200, 0.1)',
      '--snake-board-border': 'rgba(138, 126, 191, 0.18)',
      '--snake-board-top': 'rgba(239, 235, 252, 0.98)',
      '--snake-board-bottom': 'rgba(220, 212, 245, 0.94)',
      '--snake-focus-ring': 'rgba(117, 88, 200, 0.36)',
      '--snake-focus_glow': 'rgba(117, 88, 200, 0.12)',
      '--snake-cell-bg': 'rgba(126, 112, 183, 0.18)',
      '--snake-head-shadow': 'rgba(39, 142, 104, 0.28)',
      '--snake-food-shadow': 'rgba(194, 133, 22, 0.28)',
      '--footer-text': 'rgba(36, 29, 55, 0.52)',
      '--project-button-bg-top': '#3a2f58',
      '--project-button-bg-bottom': '#282040',
      '--project-button-border': 'rgba(40, 32, 64, 0.16)',
      '--project-button-text': '#faf7ff',
      '--project-button-shadow': 'rgba(58, 47, 88, 0.14)',
      '--project-button-shadow-hover': 'rgba(58, 47, 88, 0.2)',
      '--eyebrow-bg': 'rgba(255, 255, 255, 0.66)',
      '--eyebrow-border': 'rgba(138, 126, 191, 0.2)',
      '--eyebrow-text': '#463b74',
    },
  },
]
